...
class WN(torch.nn.Module):
    ...
    def forward(self, x, x_mask, g=None, **kwargs):
        ...
        for i in range(self.n_layers):
            ...
            res, skip = acts.chunk(2, dim=1)
            acts = torch.sigmoid(res) * torch.tanh(skip)
...
class ConvFlow(nn.Module):
    def __init__(
        ...
        self.convs = WN(filter_channels, kernel_size, 1, n_layers)
    ...
    def forward(self, x, x_mask, g=None, reverse=False):
        ...
        b, c, t = x0.shape
        h = h.reshape(b, c, -1, t).permute(0, 1, 3, 2)  # [b, cx?, t, ?]
...
def rational_quadratic_spline(
    ...
    if inverse:
        ...
        outputs = (outputs - left) / (right - left)
        ...
        outputs = outputs * (right - left) / (top - bottom)
